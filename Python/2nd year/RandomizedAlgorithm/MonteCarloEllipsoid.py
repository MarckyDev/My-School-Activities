...
def volume_of_ellipsoid(radiA, radiB, radiC, number_of_points):
    ...
    return volume * proportion_of_points


        #randomize points

    
    #check if points landed inside the ellipsoid 
    #if points landed inside the ellipsoid, count it

    #proportion = points inside the ellipsoid / number of points

    #return volume 

print("Estimated Volume of ellipsoid: ", volume_of_ellipsoid(2, 3, 4, 1000))
